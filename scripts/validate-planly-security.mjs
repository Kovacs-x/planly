...
const clientFiles=['v2/supabase-config.js','v2/app-v3.2.0.js','v2/hardening-v3.3b.js','v2/core-assignment-v3.3c.js','v2/core-projects-v3.3c.js','v2/core-household-calendar-v3.3c.js','v2/core-release-gate-v3.3d.js','v2/core-budget-v4.0b.js','v2/core-budget-ui-v4.0b.js','v2/core-budget-scope-v4.0c.js','v2/core-budget-lifecycle-v4.0d.js','v2/core-budget-monthly-v4.0e.js'].filter(f=>fs.existsSync(path.join(root,f))),client=clientFiles.map(read).join('\n');
