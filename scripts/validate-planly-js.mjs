...
for(const needle of ["const CACHE='planly-v2-330d04'","const VERSION='planly-v2-sw-330d04'","core-projects-v3.3c.js?v=330c02","core-build-v3.3c.js?v=330d04","core-assignment-v3.3c.js?v=330c03","core-project-planning-v3.3c.js?v=330c04","core-household-calendar-v3.3c.js?v=330c05","core-household-planning-safety-v3.3c.js?v=330c05","core-closeout-v3.3c.js?v=330c06","core-cloud-readiness-v3.3d.js?v=330d03","core-release-gate-v3.3d.js?v=330d01","await self.clients.claim()","client.navigate(client.url)"]){if(!sw.includes(needle))fail('Missing build/transition marker: '+needle)}
for(const needle of ["caches.open('planly-v2-330d04')","app-v3.2.0.js?v=330c02","core-build-v3.3c.js?v=330d04","core-project-planning-v3.3c.js?v=330c04","core-household-calendar-v3.3c.js?v=330c05","core-household-planning-safety-v3.3c.js?v=330c05","core-closeout-v3.3c.js?v=330c06","core-cloud-readiness-v3.3d.js?v=330d03","core-release-gate-v3.3d.js?v=330d01","text==='planly-v2-sw-330d04'"]){if(!build.includes(needle))fail('Offline marker mismatch: '+needle)}
