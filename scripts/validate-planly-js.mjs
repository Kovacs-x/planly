...
for(const needle of ["const CACHE='planly-v2-330c01'","const VERSION='planly-v2-sw-330c01'","core-projects-v3.3c.js?v=330c01","core-assignment-v3.3c.js?v=330c01"]){if(!sw.includes(needle))fail('Missing build marker: '+needle)}
