...
for(const needle of ["const CACHE='planly-v2-330d02'","const VERSION='planly-v2-sw-330d02'","core-projects-v3.3c.js?v=330c02","core-build-v3.3c.js?v=330d02","core-assignment-v3.3c.js?v=330c03","core-project-planning-v3.3c.js?v=330c04","core-household-calendar-v3.3c.js?v=330c05","core-household-planning-safety-v3.3c.js?v=330c05","core-closeout-v3.3c.js?v=330c06","core-cloud-readiness-v3.3d.js?v=330d02","core-release-gate-v3.3d.js?v=330d01"]){if(!sw.includes(needle))fail('Missing build marker: '+needle)}
for(const needle of ["caches.open('planly-v2-330d02')","app-v3.2.0.js?v=330c02","core-build-v3.3c.js?v=330d02","core-project-planning-v3.3c.js?v=330c04","core-household-calendar-v3.3c.js?v=330c05","core-household-planning-safety-v3.3c.js?v=330c05","core-closeout-v3.3c.js?v=330c06","core-cloud-readiness-v3.3d.js?v=330d02","core-release-gate-v3.3d.js?v=330d01","text==='planly-v2-sw-330d02'"]){if(!build.includes(needle))fail('Offline marker mismatch: '+needle)}
...
for(const needle of ["'cloud-write-test'","'offline-retry-needed'","'conflict'",'cloudWritePersisted','initial_migration_completed_at||cloudWritePersisted']){if(!cloudReadiness.includes(needle))fail('Cloud readiness persistence guard missing: '+needle)}
