...
for(const needle of ['function todayView','function upcomingView','function inboxView','function settingsView','function openSheet','function completeTaskWithUndo','function reconcilePlanlyCloud','function projectCloudRow','function planlyProjectFromCloudRow','function planlyProjectForTask','function planlyProjectStatsFor','PLANLY_HOUSEHOLD_EXTERNAL_CALENDAR_SHARING=false','function planlyMonthTasksForDate','function planlyMonthExternalForDate','Private calendar · read only','Shared means explicitly household-visible Planly tasks','commitPlanDay=function()','function planly33dReleaseGateAudit']){if(!generated.includes(needle))fail('Missing critical function: '+needle)}
for(const needle of ["const CACHE='planly-v2-330d01'","const VERSION='planly-v2-sw-330d01'","core-projects-v3.3c.js?v=330c02","core-build-v3.3c.js?v=330d01","core-assignment-v3.3c.js?v=330c03","core-project-planning-v3.3c.js?v=330c04","core-household-calendar-v3.3c.js?v=330c05","core-household-planning-safety-v3.3c.js?v=330c05","core-closeout-v3.3c.js?v=330c06","core-release-gate-v3.3d.js?v=330d01"]){if(!sw.includes(needle))fail('Missing build marker: '+needle)}
for(const needle of ["caches.open('planly-v2-330d01')","app-v3.2.0.js?v=330c02","core-build-v3.3c.js?v=330d01","core-project-planning-v3.3c.js?v=330c04","core-household-calendar-v3.3c.js?v=330c05","core-household-planning-safety-v3.3c.js?v=330c05","core-closeout-v3.3c.js?v=330c06","core-release-gate-v3.3d.js?v=330d01","text==='planly-v2-sw-330d01'"]){if(!build.includes(needle))fail('Offline marker mismatch: '+needle)}
