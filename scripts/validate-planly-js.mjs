...
for(const needle of ["const CACHE='planly-v2-330d05'","const VERSION='planly-v2-sw-330d05'","core-projects-v3.3c.js?v=330c02","core-build-v3.3c.js?v=330d05","core-assignment-v3.3c.js?v=330c03","core-project-planning-v3.3c.js?v=330c04","core-household-calendar-v3.3c.js?v=330c05","core-household-planning-safety-v3.3c.js?v=330c05","core-closeout-v3.3c.js?v=330c06","core-cloud-readiness-v3.3d.js?v=330d03","core-release-gate-v3.3d.js?v=330d01","await self.clients.claim()"]){if(!sw.includes(needle))fail('Missing build/transition marker: '+needle)}
if(sw.includes('client.navigate(client.url)'))fail('Unsafe activation-time client navigation present');
for(const needle of ["caches.open('planly-v2-330d05')","app-v3.2.0.js?v=330c02","core-build-v3.3c.js?v=330d05","core-project-planning-v3.3c.js?v=330c04","core-household-calendar-v3.3c.js?v=330c05","core-household-planning-safety-v3.3c.js?v=330c05","core-closeout-v3.3c.js?v=330c06","core-cloud-readiness-v3.3d.js?v=330d03","core-release-gate-v3.3d.js?v=330d01","text==='planly-v2-sw-330d05'"]){if(!build.includes(needle))fail('Offline marker mismatch: '+needle)}
