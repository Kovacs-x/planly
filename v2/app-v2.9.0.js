...
function todayView(){
  ...
  $('#view').innerHTML=`<div class="todayPlannerBar"><div><strong>Today's workload</strong><span>${activeToday.length} active · ${workloadText}</span></div><div class="todayPlannerActions"><button id="timelineBtn" type="button" class="timelineTodayBtn">Timeline</button><button id="planMyDayBtn" type="button">Plan my day</button></div></div><div class="progress"><div class="progressRow"><strong>${done} of ${todayAll.length} done</strong><span class="muted">${pct}%</span></div><div class="bar"><span style="width:${pct}%"></span></div></div>
...
function settingsView(){
  ...
  <div class="settingsCard"><h3>About Planly</h3><div class="muted settingsHelp">Private local-first planner. Your tasks stay on this device unless you export or sync them.</div><div class="muted" style="font-size:12px;margin-top:8px">Planly 2.9.0</div></div>`;
