...
const PLANLY_OFFLINE_CACHE='planly-preview-v3-2-p49';
const PLANLY_SW_PROBE='planly-preview-sw-p49';
...
async function verifyPlanlyOfflineCache(){
  ...
  try{
    const cache=await caches.open(PLANLY_OFFLINE_CACHE),assets=['./index.html','./app-v3.2.0-migration-preview.js?v=320p49','./supabase-config.js','./manifest.webmanifest'],missing=[];
