-- Planly 3.3B — assignee completion without edit ownership.
-- The assignee may only toggle completion on a currently assigned Household task.
-- All task editing, deletion, sharing and assignment remain creator-owned.
